...
<div class="container">
    ...
    <div class="title_room">객실선택</div>
        ...
        <div class="explain-box">
            ...
            <div class="room-box">    
                <div class="select_room" name="res_room">글램핑</div>
            </div>
    ...
    <div class="people-box">
        ...
        <div class="img-room">
            <img src="../img/caravan.jpg" width="250px">
        </div>
    ...
    <div class="people-box">
        ...
        <div class="img-room">
            <img src="../img/autocamping.jpg" width="250px">
        </div>
        ...
        <div class="explain-box">
            ...
            <div class="room-box">    
                <div class="select_room" name="res_room">오토캠핑</div>
            </div>
